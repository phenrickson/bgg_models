...
assemble_user_collection = function(collection,
                                    games) {
...
split_collection = function(data,
        ...
        if (filter == T) {
                valid_collection = 
                        data %>%
                        filter_min_users(min_users = min_users) %>%
...
make_user_split_and_resamples = function(collection,
        ...
        return(list("user_collection" = collection,
...
# function that creates recipes for users
