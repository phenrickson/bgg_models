longer_outcomes = function(data) {
    ...
    data |>
        pivot_longer(cols = c("usersrated", "averageweight", "average", "bayesaverage"),
                     names_to = "outcome",
                     values_to = "value")
}
...
get_game_types = function(data, types =  c("wargames",
                                           "abstracts",
                                           "childrensgames",
                                           "familygames",
                                           "thematic",
    ...
    filter_game_types = function(data, types =  c("wargames",
                                                  "abstracts",
                                                  "childrensgames",
                                                  "familygames",
                                                  "strategygames",
...
plot_outcomes_matrix = function(data, color = NULL) {
    ...
    data |>
        ...
        ggforce::facet_matrix(vars(c("averageweight", "average", "bayesaverage", "usersrated")), 
                              layer.diag = 2, 
                              grid.y.diag = F)+
        theme_light()+
